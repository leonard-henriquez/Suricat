...
class UserOpportunitiesController < ApplicationController
  ...
  def index
    ...
    @user_opportunities_displayed = @user_opportunities_displayed.sort_by { |op| op.personnal_grade || 0 }
    @user_opportunities_displayed = @user_opportunities_displayed.sort_by { |op| op.automatic_grade || 0 }
  end
